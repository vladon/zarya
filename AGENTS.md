...
Zarya is a cross-platform **Qt 6 / C++20** desktop client for proxy profiles and external cores (**Xray**, **sing-box**). Current version: **1.5.2** (`stable` channel).
...
- After every merge to `main`, bump the patch application version.
