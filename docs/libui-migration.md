...
3. **Main application shell**
   ...
   - Progress: the log toolbar label and actions, profile and log filter selectors, and the
     profile-list empty state use `lib_ui`; the log text engine remains a Qt primitive under the
     documented boundary.
4. **Primary workflows**
