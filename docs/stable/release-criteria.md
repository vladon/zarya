...
**1.0.0 stable** validates these criteria on the recommended path. See [docs/release/go-no-go.md](../release/go-no-go.md) and [docs/release/blockers.md](../release/blockers.md).
