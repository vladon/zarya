...
class EmbeddedXrayRuntimeHost final : public ICoreRuntimeHost {
    Q_OBJECT

public:
    explicit EmbeddedXrayRuntimeHost(CoreRuntimeCoordinator* coordinator,
...
private:
    ...
    using ConfigFunction = char* (*)(const char*, std::size_t, const char*);
